/**
 * CÓDIGO ESP32 PARA SISTEMA DE ALERTA DE TROVOADAS
 * 
 * Funcionalidade:
 * - Conecta a WiFi
 * - Consulta endpoint /alerta a cada 500ms
 * - Aciona buzzer no pino 34 conforme o alerta recebido
 * - Diferentes padrões de som para cada nível de alerta
 * 
 * Hardware necessário:
 ...
 * Níveis de alerta:
 * 0 = Sol (sem som)
 * 1 = Chuva (bips simples, intervalo de 1s)
 * 2 = Trovoada (bips contínuos, sem intervalo)
 */
...
// CONFIGURAÇÃO WIFI
// ============================================
const char* SSID = "SEU_WIFI_SSID";          // Nome da rede WiFi
